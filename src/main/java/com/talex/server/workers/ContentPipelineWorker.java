...
public class ContentPipelineWorker {
    ...
    @KafkaListener(topics = "content-copyright-result", groupId = "content-pipeline-copyright-group14")
    ...
    @KafkaListener(topics = "content-moderation-result", groupId = "content-pipeline-moderation-group14")
