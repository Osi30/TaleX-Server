...
public class ContentPipelineWorker {
    ...
    @KafkaListener(topics = "content-copyright-result", groupId = "content-pipeline-copyright-group9")
    ...
    @KafkaListener(topics = "content-moderation-result", groupId = "content-pipeline-moderation-group9")
