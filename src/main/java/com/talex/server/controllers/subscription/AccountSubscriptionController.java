...
public class AccountSubscriptionController {
        ...
        @GetMapping
        @Operation(summary = "Lấy danh sách gói đăng ký", description = "Lấy danh sách các gói đăng ký theo điều kiện lọc và phân trang.")
        ...
        @Operation(summary = "Lấy gói đăng ký theo ID", description = "Trả về thông tin chi tiết của gói đăng ký theo ID.")
        ...
        @Operation(summary = "Hủy gói đăng ký", description = "Hủy gói đăng ký theo ID, trả về mã 204 khi thành công.")
