...
public class FeatureTestController {
    ...
    @Operation(summary = "Đồng bộ sở thích động (Genres & Tags) của người dùng", description = "Kích hoạt thủ công tiến trình đồng bộ Dynamic Preferences từ QuestDB sang MongoDB")
    ...
    @Operation(
            summary = "Kích hoạt đồng bộ hóa của các series",
